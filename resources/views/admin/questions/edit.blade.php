        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="form-group{{ $errors->has('subject') ? ' has-error' : '' }}">
              ...
              <span class="required">*</span>
              {!! Form::select('subject', array('physics'=>'Physics', 'chemistry'=>'Chemistry', 'biology'=>'Biology'),null, ['class' => 'form-control select2', 'required' => 'required', 'placeholder'=>'Select Subject']) !!}
