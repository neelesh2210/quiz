...
@endsection
@section('content')
  <div style="background: url({{asset('/images/bg-login.png')}}); background-size: cover; background-position: center; background-repeat: no-repeat; position: relative; width: 100%; padding-top: 70px; padding-bottom: 150px;">
    <div class="container">
      ...
      <div class="login-page">
        ...
        <form class="form form-login" method="POST" action="{{ route('password.email') }}">
            ...
            <div class="form-group text-center">
              ...
              <a href="{{url('/login')}}" style="color:#888 !important;" > <i class="fa fa-arrow-left"></i> Get back to Login Page  </a>
            </div>
        </form>
        <form class="form login-form" method="POST" action="#">
          <div class="form-group">
            <input id="otp_num" type="number" class="form-control" name="otp_num"  placeholder="Enter OTP" required>
          </div>
